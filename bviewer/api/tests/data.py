...
class TestData:
    ...
    def loadGalleries(self):
        ...
        self.gallery_year = Gallery( parent=self.gallery_top, user=self.user_b7w, title="Happy new Year" )
        self.gallery_year.description = "Happy new Year description"
        self.gallery_year.save( )

        self.gallery_month = Gallery( parent=self.gallery_top, user=self.user_b7w, title="Happy new month" )
        self.gallery_month.description = "Happy new month description"
        self.gallery_month.save( )

        self.gallery_other = Gallery( parent=self.gallery_top, user=self.user_b7w, title="Other" )
