...
class EditTestCase(BaseResourceTestCase):
    def setUp(self):
        ...
        self.new_gallery = dict(title='New', user=user_id)
        self.new_image = dict(path='image1.jpg', gallery=gallery_id)
        self.data.generate_image(self.data.user_b7w.home, 'image1.jpg')
        self.new_video = dict(uid='123456', title='New', gallery=gallery_id)
